...
urlpatterns = [
    ...
    path('imoveis/<int:imovel_id>/demonstrar-interesse/', views.demonstrar_interesse, name='demonstrar_interesse'),
    path('interesses/<int:interesse_id>/remover/', views.remover_interesse, name='remover_interesse'),
